...
export const Planets = (props) => {
    ...
    return (
        <div className="card bg-secondary mx-3 mb-2" style={{ width: "18rem" }}>
            <img className="card-img-top border border-dark border-4 mt-1" src="https://static.wikia.nocookie.net/starwars/images/f/f0/Naboo_planet.png/revision/latest?cb=20240216051108" alt="Card image cap" />
